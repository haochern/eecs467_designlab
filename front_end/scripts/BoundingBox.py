...
class BoundingBox:
    ...
    def volume(self):
        return np.linalg.norm(np.array(self.corners[0])-np.array(self.corners[4]))*np.linalg.norm(np.array(self.corners[0])-np.array(self.corners[1]))*np.linalg.norm(np.array(self.corners[0])-np.array(self.corners[2]))
